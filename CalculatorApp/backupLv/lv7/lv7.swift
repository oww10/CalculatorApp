...
class lv7ViewController: UIViewController, makeLineButtons{
    ...
    @objc func buttonTapped(_ sender: UIButton){
        ...
        // setTitle을 가져오기
        guard let buttonNum: String = sender.titleLabel?.text else{
            return
        }
        ...
        if buttonNum == "="{
            let result = calculate(expression: defaltTextNum)
